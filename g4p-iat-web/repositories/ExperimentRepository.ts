...
class ExperimentRepository {
    ...
    constructor() {
        _sprites = {
            "s1": new Sprite("sp1", "sprites/15x40/sprite-arab-angry-smile-small.jpg", 7680, 15360, 40, 15, 600),
            "s2": new Sprite("sp2", "sprites/15x40/sprite-arab-angry-smile-teeth-small.jpg", 7680, 15360, 40, 15, 600),
            "s3": new Sprite("sp3", "sprites/15x40/sprite-arab-smile-angry-teeth-small.jpg", 7680, 15360, 40, 15, 600),
            "s4": new Sprite("sp4", "sprites/15x40/sprite-arab-smile-angry-small.jpg", 7680, 15360, 40, 15, 600),
            "s5": new Sprite("sp5", "sprites/15x40/sprite-jew-angry-smile-small.jpg", 7680, 15360, 40, 15, 600),
            "s6": new Sprite("sp6", "sprites/15x40/sprite-jew-angry-smile-teeth-small.jpg", 7680, 15360, 40, 15, 600),
            "s7": new Sprite("sp7", "sprites/15x40/sprite-jew-smile-angry-teeth-small.jpg", 7680, 15360, 40, 15, 600),
            "s8": new Sprite("sp8", "sprites/15x40/sprite-jew-smile-angry-small.jpg", 7680, 15360, 40, 15, 600)
        };
    }
    ...
    fetch() {
        ...
        return $.when(true).then(function(){
            ...
            experiment.template.questions.forEach(function(question){
                question.sprite = _sprites[question.spriteId]; 
            });
